...
class ChatGRPCStub:
    """Service สำหรับจัดการระบบสนทนา AI
    """
...
def add_ChatGRPCServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'chat.v1.ChatGRPC', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('chat.v1.ChatGRPC', rpc_method_handlers)
